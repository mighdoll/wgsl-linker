...
export type ExportOld = TextExportOld | GeneratorExport;
...
export type CodeGenFn = (params: Record<string, string>) => string | TextInsertOld;

export interface GeneratorExport extends ExportBaseOld {
  generate: CodeGenFn;
}
