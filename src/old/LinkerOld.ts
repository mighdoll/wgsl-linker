...
export type WgslModuleOld = TextModuleOld | GeneratorModuleOld;

export interface ModuleBaseOld {
...
export interface TextModuleOld extends ModuleBaseOld {
  template?: string;
  exports: TextExportOld[];
}

/** module with exportable text generated by a function */
export interface GeneratorModuleOld extends ModuleBaseOld {
  exports: GeneratorExportOld[];
}

/** a single exportable text fragment */
export type ExportOld = TextExportOld | GeneratorExportOld;

export interface ExportBaseOld {
  /** name of function or struct being exported */
  name: string;
  params: string[];
}

export interface TextExportOld extends ExportBaseOld, TextInsertOld {}

/** a code fragment or two to be inserted */
export interface TextInsertOld {
...
export type CodeGenFnOld = (params: Record<string, string>) => string | TextInsertOld;

export interface GeneratorExportOld extends ExportBaseOld {
  generate: CodeGenFnOld;
}

/** parse source text for #import directives, return wgsl with all imports injected */
export function linkWgslOld(
  src: string,
